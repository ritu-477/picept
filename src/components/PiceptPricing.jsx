                ...
                <div className="pt-[82px]">
                    <div className="lg:flex-row flex flex-col gap-6">
                        {PRICING_PLANS.map((plan) => (
                            <div
                                key={plan.id}
                                className="lg:w-1/2 w-full border flex backdrop:blur-[20px] h-[908px] flex-col justify-between rounded-[20px] border-charcoal-gray bg-jet-black">
                                <div className="flex flex-col">
                                    <div className="flex justify-between p-[24px_24px_0_24px]">
                                        <div
                                            className={`size-14 -mt-[50px] py-[10px] px-[10px] border rounded-lg ${plan.iconClass} border-border-primary-gray`}>
                                    ...
                                    <p
                                        className={`md:text-custom-4xl sm:text-2xl md:leading-custom-xl font-bold px-6 ${plan.id === 1 ? "text-primary-white" : "text-vivid-green"
                                            }`}>
                                        {plan.type}
                                    </p>
                                    <p className="sm:text-2xl text-xl leading-7 pt-5 text-primary-white font-bold px-6 pb-4">
                                        {plan.price}
                                    </p>
